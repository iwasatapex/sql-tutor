...
function renderState(payload){renderTopics(payload.topics,payload.selected_topic);renderDifficulty(payload.selected_difficulty);renderQuestionType(payload.question_type);renderExercise(payload.exercise);renderDebugPanel(payload.exercise);renderStats();renderFeedback(payload.feedback)}
...
_SUPPORTED_QUESTION_TYPES = ("write", "debug")
